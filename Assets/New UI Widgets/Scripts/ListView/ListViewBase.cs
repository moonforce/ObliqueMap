...
namespace UIWidgets
{
			...
			ISubmitHandler, ICancelHandler
	{
		...
		public virtual void Select(int index, bool raiseEvents)
		{
            ...
            var control_pressed = Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl);
            var shift_pressed = Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift);
            if (!MultipleSelect || (!shift_pressed && !control_pressed))
			{
		...
		void Toggle(ListViewItem item)
		{
            ...
            else if (MultipleSelect && !shift_pressed && !control_pressed && have_selected)
            {
                selectedIndices.Items().ForEach(Deselect);
            }
